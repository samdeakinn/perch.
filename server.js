...
function securityHeaders(req, res, next) {
  ...
  res.setHeader('Content-Security-Policy', "default-src 'self'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; worker-src 'self' https://cdnjs.cloudflare.com; connect-src 'self'");
  next();
}
...
const articles = [
  ...
  { slug: 'gym-contract-traps', title: 'gym contract traps: minimum terms, notice periods, and the £300 ghost membership', excerpt: 'uk gyms see 40–60% of revenue from members who visit less than once a month. here\'s how the contracts are designed to keep you paying.', date: '3 Jul 2026', readTime: 4, template: 'gym-contract-traps' },
  { slug: 'mobile-upgrade-costs', title: 'the free mobile upgrade that costs you £900', excerpt: '\'free upgrade\' is one of the most successful marketing frames in british telecoms. it\'s a contract renewal dressed as a gift — and it costs you hundreds.', date: '3 Jul 2026', readTime: 3, template: 'mobile-upgrade-costs' },
  { slug: 'streaming-service-creep', title: '£78/month for content you don\'t watch: the streaming subscription creep', excerpt: 'six services later, you\'re paying £936/year. the model is built on you forgetting how many you have. here\'s how to audit and save.', date: '3 Jul 2026', readTime: 3, template: 'streaming-service-creep' },
  { slug: 'pet-insurance-loyalty', title: 'pet insurance: the loyalty penalty nobody talks about', excerpt: 'average renewal hikes of 18–34%, with older pets facing 40%+ increases. and because of pre-existing conditions, most owners can\'t switch.', date: '3 Jul 2026', readTime: 4, template: 'pet-insurance-loyalty' },
  { slug: 'travel-insurance-auto-renewal', title: 'why annual travel insurance is usually the wrong call', excerpt: 'the average brit takes 2.4 trips a year. single-trip policies cost half what annual policies do. but annual auto-renews, so most people keep paying.', date: '3 Jul 2026', readTime: 3, template: 'travel-insurance-auto-renewal' },
  { slug: 'landlord-insurance-chaos', title: 'managing renewals across 5 properties: the landlord\'s quiet nightmare', excerpt: '15–25 renewal events per year, each on a different date, with uncapped loyalty penalties. here\'s how perch. helps landlords track everything.', date: '3 Jul 2026', readTime: 4, template: 'landlord-insurance-chaos' },
